...
const features = [
  {
    ...
    description:
      "Select body muscles from an interactive SVG diagram and generate relevant workouts instantly.",
  ...
  },
  {
    ...
    description:
      "Fresh daily challenges that push consistency and encourage healthy habits.",
...
const Hero = () => {
  ...
  useEffect(() => {
    const handleWheel = (e) => {
      ...
      const isAtBottom =
        scrollTop + containerHeight >= container.scrollHeight - 10;
  ...
  const scrollCarousel = (direction) => {
    ...
    setCurrentFeatureIndex(
      Math.max(0, Math.min(newIndex, features.length - 1)),
    );
  };
              ...
              {[...features, ...features].map((feature, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`absolute top-0 left-0 right-0 h-1 transition-all duration-500 opacity-50 group-hover:opacity-100 ${isCyan ? "bg-cyan-400 shadow-[0_0_15px_#22d3ee]" : "bg-fuchsia-500 shadow-[0_0_15px_#d946ef]"}`}
                    />

                    <div className="absolute inset-0 flex flex-col items-center justify-center p-12 text-center z-10">
                      {/* LARGE NEON ICON */}
                      <div
                        className={`transition-all duration-500 group-hover:scale-125 ${neonText} ${neonGlow}`}
                      >
                    ...
                    <span
                      className={`absolute bottom-10 right-10 font-black text-9xl italic select-none pointer-events-none opacity-10 transition-all duration-700 group-hover:opacity-30 group-hover:scale-110 ${neonText}`}
                    >
